            ...
            <div className="flex items-center gap-2.5 cursor-pointer rounded-xl p-3 hover:bg-white/5 transition-colors duration-150">
              ...
              <div className="relative shrink-0">
                {userData?.avatar || !imgErr ? (
                    <img src={userData?.avatar} alt="Avatar" className="w-9 h-9 rounded-xl object-cover border-2 border-indigo-500/25" onError={()=>setImgErr(true)} />
                ) : (
                  <div className="w-9 h-9 rounded-xlbg-white/6 flex items-center justify-center"><User size={18} className="text-slate-400"/></div>
                )}
              </div>
              {/* Username and plan */}
              ...
              <div className="flex gap-1">
                ...
                <button onClick={handleLogout} className="flex items-center justify-center w-7 h-7 roounded-sm border-none bg-transparent text-gray-600 cursor-pointer hover:text-gray-400 transition-all duration-150">
                  <LogOut size={16}/>
                </button>
              </div>
            </div>
